...
from utils.graph_utils import tf_mse_loss, tf_mae_loss, tf_huber_loss, GetTokenEmbedding, tf_alpha_beta_weight, \
...
class BasicRegressionModel(GlobalVgg16Cnn):
    ...
    def __init__(self, image_width: int, image_height: int, furniture_nums: int, label_size: int, furniture_width: int,
        ...
        room_a = tf.placeholder(name="room_a", shape=(None, image_height, image_width), dtype=tf.int32)
        room_b = tf.placeholder(name="room_b", shape=(None, image_height, image_width), dtype=tf.int32)
        self.room_a = room_a
        self.room_b = room_b
